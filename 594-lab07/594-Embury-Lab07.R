...
# save term frequency, ??, ??, and vocab, in a list as the data object "Tweet_Topics".
...
# assign Tweet to the topic that occurs most frequently within the Tweet (give each Tweet a dominant topic)
